...
public final class AvgMonWrkDriver_KPI3
{
	public final static void main(String[] args) throws Exception
	{
		args = new String[] { 
				...
				"/media/hadoop/156d5b2f-6481-4a81-b1bb-56e2179981bb1/ramesh/2018 life/hadoop/DataFlair/Assignments/9.HR_Analysis/Output_Data_KPI3/"};
		...
		job.setJarByClass(AvgMonWrkDriver_KPI3.class);
		job.setMapperClass(AvgMonWrkMapper_KPI3.class);
		job.setReducerClass(AvgMonWrkReducer_KPI3.class); 
