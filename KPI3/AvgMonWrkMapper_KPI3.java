package com.ramesh.hranalysis; 
	...
	public class AvgMonWrkMapper_KPI3 extends Mapper<LongWritable, Text, Text, IntWritable>
	{
...
//		0.38,0.53,2,157,3,0,1,0,sales,low
			...
			{					
				final int montlywrkhrs = Integer.parseInt(data[3]);	//214.05
				final String department =data[8];
				context.write(new Text (department), new IntWritable(montlywrkhrs));
