...
public final class DeptDetailsDriver_KPI7
{
	public final static void main(String[] args) throws Exception
	{
		...
		args = new String[] { 
				...
				"/media/hadoop/156d5b2f-6481-4a81-b1bb-56e2179981bb1/ramesh/2018 life/hadoop/DataFlair/Assignments/9.HR_Analysis/Output_Data_KPI7/"};
		...
		job.setJarByClass(DeptDetailsDriver_KPI7.class);
		job.setMapperClass(DeptDetailsMapper_KPI7.class);
		job.setReducerClass(DeptDetailsReducer_KPI7.class); 
