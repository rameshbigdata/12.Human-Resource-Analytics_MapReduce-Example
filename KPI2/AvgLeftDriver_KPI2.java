...
public final class AvgLeftDriver_KPI2
{
	public final static void main(String[] args) throws Exception
	{
		args = new String[] { 
				...
				"/media/hadoop/156d5b2f-6481-4a81-b1bb-56e2179981bb1/ramesh/2018 life/hadoop/DataFlair/Assignments/9.HR_Analysis/Output_Data_KPI2/"};
		...
		job.setJarByClass(AvgLeftDriver_KPI2.class);
		job.setMapperClass(AvgLeftMapper_KPI2.class);
		job.setReducerClass(AvgLeftReducer_KPI2.class);
