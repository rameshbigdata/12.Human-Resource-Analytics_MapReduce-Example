package com.ramesh.hranalysis; 
	...
	public class PromotedLeftMapper_KPI6 extends Mapper<LongWritable, Text, Text, IntWritable>
	{
...
//		0.38,0.53,2,157,3,0,1,0,sales,low
			...
			if ((data.length == 10) && (!data[0].contains("satisfaction_level")) && (Integer.parseInt(data[6])==1) && (Integer.parseInt(data[7])==1))				// check length of the data
			{					
...
//				(ConstantKey,214.05) output to reducer
			...
			{
				final String department =data[8];
				context.write(new Text (department), new IntWritable(0));
			}
		}
	}